...
@section('title') Surveying | Odisha Testing Laboratoty and Consultancy Services  @endsection

@section('description') Otlconsultancy's Total Quality Assurance surveying services have become an essential element in managing the entire life cycle of a project from design and construction through to installation, upgrade and revamp @endsection
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <h3 class="font-size-35 line-height-normal margin-bottom-10 capitalization">Surveying</h3>
                                    ...
                                    <p class="align-justify font-size-24 margin-bottom-20">Otlconsultancy onshore and offshore surveying services help customers meet engineering, construction and asset record challenges.</p>
                                    <p class="align-justify font-size-16 margin-bottom-50">Effective surveying services offer unprecedented gains for clients working in the offshore and process industries. Shortening project duration, improved site safety, increased accuracy, reduced field time and minimal rework are just some of the benefits. Otlconsultancy's Total Quality Assurance surveying services have become an essential element in managing the entire life cycle of a project from design and construction through to installation, upgrade and revamp.</p>
                                    <div class="row">
